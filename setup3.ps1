...
'@ | Set-Content -Path ".env.local.example"
...
'@ | Set-Content -Path "src\lib\db.ts"
...
'@ | Set-Content -Path "src\lib\email.ts"
...
'@ | Set-Content -Path "src\lib\matching.ts"
...
'@ | Set-Content -Path "src\pages\_app.tsx"
...
'@ | Set-Content -Path "src\pages\index.tsx"
...
'@ | Set-Content -LiteralPath "src\pages\draw\[id].tsx"
...
'@ | Set-Content -Path "src\pages\api\create-draw.ts"
...
'@ | Set-Content -Path "src\pages\api\get-draw.ts"
...
'@ | Set-Content -Path "src\pages\api\send-emails.ts"
...
'@ | Set-Content -Path "src\pages\api\delete-draw.ts"
...
'@ | Set-Content -Path "src\styles\Home.module.css"
...
'@ | Set-Content -Path "src\styles\Draw.module.css"
...
'@ | Set-Content -Path "sql\setup.sql"
